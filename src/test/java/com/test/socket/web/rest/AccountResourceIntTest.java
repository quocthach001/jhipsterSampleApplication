package com.test.socket.web.rest;

import com.test.socket.config.Constants;
import com.test.socket.JhipsterSampleApplicationApp;
import com.test.socket.domain.Authority;
import com.test.socket.domain.User;
import com.test.socket.repository.AuthorityRepository;
import com.test.socket.repository.UserRepository;
import com.test.socket.security.AuthoritiesConstants;
import com.test.socket.service.MailService;
import com.test.socket.service.dto.UserDTO;
import com.test.socket.web.rest.errors.ExceptionTranslator;
import com.test.socket.web.rest.vm.KeyAndPasswordVM;
import com.test.socket.web.rest.vm.ManagedUserVM;
import com.test.socket.service.UserService;
